...
public class ConvertNumbersToWords{
	...
	public String converter(BigInteger numb) throws IOException {
		...
		/*
	      i, j, k служебные переменные для итерирования по числу
		*/
	...
	/* В метод передаются строки вида xyz, xy, x 
       и порядок соответствующий им.
    */
	private String convertNumber(String numb, String degree) {
		...
		switch(sum) {
			case 3:
				/* Возможные вариации числа xyz: x00, x0z, xyz
				   Для степени 1 реализована замена один и два на одна и две соответсвенно.
				*/
